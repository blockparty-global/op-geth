...
import (
	...
	"github.com/blockparty-global/op-geth/crypto/signify"
	"github.com/blockparty-global/op-geth/internal/build"
	"github.com/blockparty-global/op-geth/internal/download"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/blockparty-global/op-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/blockparty-global/op-geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/blockparty-global/op-geth/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/blockparty-global/op-geth/core/rawdb", "github.com/blockparty-global/op-geth/ethdb/leveldb"},
		{"github.com/blockparty-global/op-geth/core/rawdb", "github.com/blockparty-global/op-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
